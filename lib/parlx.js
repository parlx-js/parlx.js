...
function () {
  function Parlx(element) {
    ...
    _defineProperty(this, "onWindowScroll", function () {
      if (_this.element) {
        ...
        if (typeof _this.methods.onScroll === 'function') {
          _this.methods.onScroll(_this.element);
        }
      }
    });
    ...
    _defineProperty(this, "onWindowResize", function () {
      if (_this.element) {
        ...
        if (typeof _this.methods.onResize === 'function') {
          _this.methods.onResize(_this.element);
        }
      }
    });
  ...
  _createClass(Parlx, [{
    ...
    value: function init() {
      ...
      if (elements instanceof Node) elements = [elements];else if (elements instanceof NodeList) elements = [].slice.call(elements);else if (!(elements instanceof Array)) return;
