  ...
  _createClass(Parlx, [{
    ...
    value: function parallaxEffect() {
      ...
      if (this.settings.axis.toLowerCase() === 'y') {
        if (this.settings.base === window ? this.settings.base.pageYOffset >= 0 && this.settings.base.pageYOffset + this.settings.base.innerHeight <= document.documentElement.scrollHeight : this.settings.base.scrollTop >= 0 && this.settings.base.scrollTop + this.settings.base.offsetHeight >= document.documentElement.scrollHeight) {
          this.scrolled = this.element.getBoundingClientRect().top;
        }
      } else if (this.settings.axis.toLowerCase() === 'x') {
        if (this.settings.base === window ? this.settings.base.pageXOffset >= 0 && this.settings.base.pageXOffset + this.settings.base.innerWidth <= document.documentElement.scrollWidth : this.settings.base.scrollLeft >= 0 && this.settings.base.scrollLeft + this.settings.base.offsetWidth >= document.documentElement.scrollWidth) {
      ...
      if (this.settings.type === 'foreground') {
        ...
        Object.assign(this.element.querySelector('.parlx-children').style, {
          transform: this.transform,
          objectFit: 'cover',
          minWidth: "".concat(this.element.offsetWidth * (1 + Math.abs(this.settings.speed) * 2), "px"),
    ...
    value: function extendSettings(settings) {
      var defaultSettings = {
        axis: 'Y',
        // get scroll values from X or Y axis
        base: window,
        // get scroll position from this element
        direction: 'vertical',
